 ...
 * 2018/07/06 009727  
 * Cust 相關之商業邏輯
 * @module services/system_base/cust_service
 */
...
module.exports.login =  async (req, res, next) => {
	...
	try{
		...
		debug(req.body.data.account+" "+req.body.data.password+" "+req.body.data.type+" "+req.body.data.googletoken+" from:"+req.body.requester);
		// check parameters
